...
#define DELETED "del" // stored in product ID field *
   ...
   * 1)  To facilitate the checking of the machine problem, follow the instructions in each PROBLEM #. 
   * 2)  To accomplish the task for each PROBLEM, a series of function calls may be necessary. 
