...
void deleteProdByPrice(productList *PL, int price);
...
//			 displayProductList(toRestock);
			printf("Input price of the product you want to delete: ");
        	scanf("%d", &delPrice);
        	deleteProdByPrice(&PL, delPrice);
            break;
		case '0':
